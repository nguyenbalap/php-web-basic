...
require "../connect.php";
$sql = "select orders.*, customer.name,customer.address,customer.phone from orders join customer on orders.customer_id = customer.id && orders.status = 1";
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-5">
                <div
                    ...
                    <h1 class="h2">Đơn đang giao(<?php echo count($num) ?>)</h1>
                                ...
                                <td><?php
                                        switch ($each['status']) {
                                            case 0:
                                                ...
                                                break;
                                            case 1:
                                                echo "<span class='text-warning'>Đang giao </span>";
                                                break;
                                            case 2:
